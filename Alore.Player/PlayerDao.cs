        ...
        internal async Task<IPlayer> GetPlayerById(uint id)
        {
            ...
            await CreateTransaction(async transaction =>
            {
                await Select(transaction, async reader =>
                    ...
                    "SELECT id, credits, activity_points as duckets, vip_points as diamonds, rank, username, auth_ticket, figure, gender, motto FROM players WHERE id = @0 LIMIT 1;",
                    id);
            });
            return player;
        }
        ...
        internal async Task<IPlayer> GetPlayerBySso(string sso)
        {
            ...
            await CreateTransaction(async transaction =>
            {
                await Select(transaction, async reader =>
                    ...
                    "SELECT id, credits, activity_points as duckets, vip_points as diamonds, rank, username, auth_ticket, figure, gender, motto FROM players WHERE auth_ticket = @0 LIMIT 1;",
                    sso);
            });
            return player;
        }
        ...
        internal async Task<IPlayerSettings> GetPlayerSettingsById(uint id)
        {
            ...
            await CreateTransaction(async transaction =>
            {
                await Select(transaction, async reader =>
                    ...
                    "SELECT navigator_x as navi_x, navigator_y as navi_y, navigator_width as navi_width, navigator_height as navi_height, navigator_show_searches as navi_hide_searches FROM player_settings WHERE player_id = @0 LIMIT 1;",
                    id);
            });
        ...
        internal async Task<IPlayerStats> GetPlayerStatsById(uint id)
        {
            ...
            await CreateTransaction(async transaction =>
            {
                await Select(transaction, async reader =>
                    ...
                    "SELECT total_respect_points as respect, daily_respects as daily_respect, daily_scratches as daily_pet_points FROM player_stats WHERE player_id = @0 LIMIT 1;",
                    id);
            });
